...
const LandingPage = () => {
  ...
  return (
      <div className="bg-[#ebefff] min-h-screen text-[#3b3e88] flex flex-col">
        ...
        {/* Hero Section */}
        <main
            className="flex-1 flex flex-col md:flex-row items-center justify-center px-6 md:px-12 lg:px-24 py-12 gap-8 md:gap-12">
          <div className="md:w-1/2 space-y-6 text-center md:text-left">
            ...
            <p className="text-lg md:text-xl text-[#b9c0de] max-w-lg">
              Plan the perfect movie night with friends, without the endless &#34;what should we watch?&#34; back-and-forth.
            </p>
        ...
        {/* Features Section */}
        <section id="features-section" className="bg-white py-16 px-6 md:px-12 lg:px-24">
          <h3 className="text-2xl md:text-3xl font-bold text-center mb-12 text-[#3b3e88]">How it works</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-[#ebefff] rounded-2xl p-6 border border-[#3b3e88]/10 shadow-lg">
              ...
              <h4 className="text-xl font-semibold mb-2 text-[#3b3e88]">Create Your Watchlist</h4>
              <p className="text-[#b9c0de]">Build your personal watchlist of movies you&#39;re dying to see. Search the vast library or browse by genre.</p>
            </div>
            ...
            <div className="bg-[#ebefff] rounded-2xl p-6 border border-[#3b3e88]/10 shadow-lg">
              ...
              <h4 className="text-xl font-semibold mb-2 text-[#3b3e88]">Form Movie Crews</h4>
              <p className="text-[#b9c0de]">Create groups with friends and easily schedule movie nights together. Invite anyone with just a username.</p>
            </div>
            ...
            <div className="bg-[#ebefff] rounded-2xl p-6 border border-[#3b3e88]/10 shadow-lg">
              ...
              <h4 className="text-xl font-semibold mb-2 text-[#3b3e88]">Vote & Enjoy</h4>
              <p className="text-[#b9c0de]">Everyone contributes movie suggestions and votes on their favorites. Our algorithm selects the winner - no more debating!</p>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 px-6 md:px-12 lg:px-24 text-center">
          <div className="bg-gradient-to-r from-orange-400 to-orange-500 rounded-3xl p-12 shadow-lg text-white">
            <h3 className="text-2xl md:text-3xl font-bold mb-6">Ready to transform movie night?</h3>
            <p className="text-white/90 max-w-2xl mx-auto mb-8">
              Join thousands of movie lovers who have simplified their movie nights.
              Sign up today and make your next movie night drama-free (except for the movies themselves).
            </p>
            <Button
        ...
        <footer className="bg-white py-8 px-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex items-center gap-2 mb-4 md:mb-0">
              ...
              <span className="text-sm font-medium text-[#3b3e88]">Movie Night Planner </span>
            </div>
          </div>
        </footer>
      </div>
