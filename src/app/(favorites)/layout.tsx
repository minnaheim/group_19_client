            ...
            <div className="bg-white rounded-2xl sm:rounded-3xl shadow-xl overflow-hidden border-0 relative z-10">
              ...
              <div className="p-5 sm:p-6 md:p-8 lg:p-10">
                ...
                <div className="mt-6 sm:mt-8 flex justify-center space-x-2 hidden sm:flex">
                  ...
                  <div className="hidden md:block w-8 h-12 sm:w-10 sm:h-14 md:w-12 md:h-16 bg-indigo-500/20 rounded-lg shadow-sm transform -rotate-3">
                  </div>
                  <div className="hidden lg:block w-8 h-12 sm:w-10 sm:h-14 md:w-12 md:h-16 bg-amber-500/20 rounded-lg shadow-sm transform rotate-12">
                  </div>
                </div>
              </div>
            </div>
