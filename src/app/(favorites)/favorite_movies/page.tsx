      ...
      <div className="space-y-6">
        ...
        {genreMovies.length === 0 && !isLoading && !error && (
            <div className="bg-orange-100 border-l-4 border-orange-500 text-orange-700 p-4 rounded-xl shadow-sm">
              <div className="flex items-center">
                ...
                <p>
                  No movies found for your selected genre. Please go back and select a different genre.
                </p>
              </div>
            </div>
        )}
        ...
        <div className="relative">
          <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
            <svg className="w-5 h-5 text-[#b9c0de]" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        {isLoading && (
            <div className="text-center py-8">
              <div className="inline-block animate-spin rounded-full h-12 w-12 border-t-2 border-b-2 border-[#3b3e88]"></div>
              <p className="text-[#3b3e88] mt-4">Finding the perfect movies for you...</p>
            </div>
        )}
