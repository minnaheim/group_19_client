      ...
      <div className="flex-1 p-6 overflow-auto">
          ...
          {isSearching && displayMovies.length === 0 && (
            <div className="flex flex-col items-center justify-center h-full">
              <p className="text-gray-500 text-lg mb-4">
                none of the movies on your watchlist match your search
              </p>
          ...
          <div className="flex flex-wrap gap-6">
            {displayMovies.map((movie) => (
              <div
                ...
                onClick={
                  isEditing ? () => handleMovieSelect(movie.id) : undefined
                }
              >
                <img
        ...
        {searchQuery && !isEditing && (
          <div className="mt-4 text-[#3b3e88]">
            ...
            in {searchCategory === "all" ? "all categories" : searchCategory}
          </div>
        )}
