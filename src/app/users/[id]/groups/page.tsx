...
const GroupsManagement: React.FC = () => {
  ...
  useEffect(() => {
    const fetchAvailableFriends = async () => {
      ...
      try {
        ...
        if (selectedGroupId) {
          const groupDetails = groupsWithDetails.find((g) =>
  ...
  const handleInviteSelectedFriends = async () => {
    ...
    try {
      ...
      setInviteError(
        "Failed to send one or more invitations. Please try again.",
      );
    } finally {
                          ...
                          {filteredAvailableFriends.map((friend) => (
                            ...
                            >
                              <input
                                ...
                                checked={selectedFriends.some((f) =>
                                  f.userId === friend.userId
                                )}
