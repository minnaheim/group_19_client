...
const GroupsManagement: React.FC = () => {
  ...
  const fetchAllUsers = useCallback(async () => {
    ...
    try {
      ...
      setInviteError("Could not load user search. Using regular search instead.");
  ...
  const getErrorMessage = (err: unknown, defaultMessage: string): string => {
    if (err instanceof Error && "status" in err) {
      ...
      if (
          appErr.message && typeof appErr.message === "string" &&
          appErr.message.length > 0 && appErr.message !== "No message available"
      ) {
  ...
  if (
      error && !groups.length && !receivedInvitations.length &&
                          ...
                          {filteredGroups.map((group) => (
                              ...
                              >
                                ...
                                <div className="flex items-center justify-between mb-2">
                                  ...
                                  <span
                                      className="text-xs bg-indigo-100 text-indigo-700 px-2 py-1 rounded-full flex-shrink-0">
                            ...
                            >
                              <div className="mb-3">
                                ...
                                <p className="text-[#b9c0de] text-xs mb-1">
                                  ...
                                  {new Date(invitation.creationTime)
                                      .toLocaleDateString()}
                                </p>
                              </div>
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                              ...
                              {selectedGroup.movies && selectedGroup.movies.length > 0
                                  ? (
                                      <div
                                          className="space-y-3 max-h-60 overflow-y-auto pr-2 bg-indigo-50 rounded-xl p-4">
