...
const MovieCard: React.FC<MovieCardProps> = ({
  ...
  return (
      <div
          ...
          } group ${isSelectingFavorite ? "hover:ring-2 hover:ring-[#ff9a3e]" : ""}`}
          onClick={handleClick}
      >
        <img
        ...
        {/* Display a permanent star icon for favorite movies in profile/edit views */}
        {!isSelectingFavorite && !isEditing && isInWatchlist === false && isInSeenList === false && (
